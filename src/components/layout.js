            ...
            <div className={`body ${this.state.isMenuVisible ? 'is-menu-visible' : ''}`}>
                <Helmet
                    ...
                    meta={[
                        ...
                        { name: 'image', content: 'https://graphql-asia.org/GraphQL-Asia-Banner.png?1' },
                        { name: 'og:url', content: 'https://graphql-asia.org' },                        
                        { name: 'og:title', content: 'GraphQL Asia in Bengaluru, India' },                        
                        { name: 'og:image', content: 'https://graphql-asia.org/GraphQL-Asia-Banner.png?1' },
                        { name: 'twitter:image', content: 'https://graphql-asia.org/GraphQL-Asia-Banner.png?1' },
